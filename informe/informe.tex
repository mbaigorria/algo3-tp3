...
\input{busqueda_local}
\newpage
%\input{busqueda_local_exp}
\newpage
...
\section{Codigo}
\subsection{data\_structures.h}
\lstinputlisting[language=C++, breaklines=true]{../src/data_structures.h}
\newpage
