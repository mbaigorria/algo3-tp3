...
\begin{subfigure}[b]{0.4\textwidth}
	\includegraphics[scale=0.6]{graph/{output_grasp_3_5_circulos.csvTime}.pdf}
	\begin{center}
	GRASP3
	\end{center}
\end{subfigure}
\begin{subfigure}[b]{0.4\textwidth}
	\includegraphics[scale=0.6]{graph/{output_grasp_3_5_circulos.csvSolution}.pdf}
	\begin{center}
...
Como era de esperar, la heuristica GRASP no se comporto de la misma forma que lo hizo con la familia aleatoria,